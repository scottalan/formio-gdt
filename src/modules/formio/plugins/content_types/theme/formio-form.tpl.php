...
<iframe id="formio-form-<?php print $formio_name; ?>" style="width:100%;border:none;" height="250px"
  src="/<?php print $module_path; ?>/view/src/view/index.html#/<?php print $project_hash; ?>/form/<?php print $formio_id; ?>?action=<?php print $callback; ?>&iframe=1<?php print $theme; ?>&header=0&token=<?php print $token; ?>">
</iframe>
