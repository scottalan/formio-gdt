...
/**
 * @file
 * Contains \Drupal\formio\Plugin\formatter\FormatterFormio.
 */

namespace Drupal\formio\Plugin\formatter;
 ...
 *   id = "formio",
 *   label = "Formio JSON",
 *   description = "Output for Formio forms."
 * )
 */
class FormatterFormio extends Formatter implements FormatterInterface {
  ...
  public function parseBody($body) {
    ...
    // Convert data from formio format to Drupal format.
